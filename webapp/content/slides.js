...
window.ACOLYTE_SLIDES = [
  ...
  { id: 11, act: 3, actLabel: 'Un agent travaille', title: 'Un workflow, pas une boîte noire', message: 'Un agent produit des étapes, des artefacts et des preuves. Il ne transforme pas automatiquement une proposition en décision finale.', bullets: ['Chaque étape : entrée, action, observation, sortie.', 'Une erreur peut déclencher correction ou arrêt.', 'Une décision sensible peut demander un humain.', 'Proposition → exécution contrôlée → test → validation.'], visual: 'control', source: 'Contrôle · preuves · gate humain', speaker: 'Plus l’IA agit, plus il faut rendre son travail visible : ce qu’elle a vu, ce qu’elle a fait, ce qu’elle ignore et qui valide.', demo: 'Animation : arrêt sur validation humaine.', interactive: true },
  {
    id: 12,
    act: 4,
    actLabel: 'Comment HOCUS travaille',
    ...
    interaction: {
      ...
      artifact: { name: 'ANALYSEUR DE DCE', id: 'BRIEF-001' },
      stages: [
  ...
  { id: 19, act: 5, actLabel: 'De l’idée au produit', title: 'Du code à l’application testée', message: 'Le produit est construit par une chaîne d’artefacts, de contrôles et de validation humaine.', bullets: ['SPEC → ISSUE → CODE → TESTS.', 'PR → STAGING → APPLICATION.', 'Chaque étape laisse une preuve.', 'La dernière étape est visible, pas magique.'], visual: 'delivery', source: 'Cycle traçable', speaker: 'Le résultat final n’est pas apparu d’un coup : chaque étape a laissé une preuve de ce qui a été décidé et produit.', demo: 'Capture / replay · pas de modification distante en direct.', wow: true, interactive: true },
  { id: 20, act: 5, actLabel: 'De l’idée au produit', title: 'Mini-cas : tester la valeur avant d’industrialiser', message: 'Lorsque la question principale est la valeur ou la faisabilité, on teste rapidement avant d’industrialiser.', bullets: ['Question → POC → données → patterns.', 'Parcours et comportements observés.', 'Résultat, stabilité, limites.', 'Point de décision : continuer / itérer / arrêter.'], visual: 'sybil', source: 'Cas secondaire · données publiques', speaker: 'On ne construit pas systématiquement une usine pour découvrir ensuite que personne n’en a besoin.', demo: 'Replay 60–90 s ou capture du graphe · optionnel en version courte.', demoType: 'OPTIONAL', interactive: true },
  { id: 21, act: 5, actLabel: 'De l’idée au produit', title: 'Un même système, plusieurs agents spécialisés', message: 'Une architecture de travail peut réutiliser le même cadre avec des moteurs spécialisés par responsabilité.', bullets: ['Gremlin : acquérir signaux, sources et données.', 'Moteurs de décision, dont Stolas : comprendre, comparer, décider.', 'Inat, Yokai, Doppel : structurer, produire, transformer.', 'Cortex : orchestrer, gouverner, demander des preuves.'], visual: 'specialized', source: 'WOW 4 · carte Hocus simplifiée', speaker: 'La spécialisation ne sert pas à multiplier les logos. Elle sert à donner à chaque moteur un travail clair et contrôlable.', demo: 'Simulation d’un dossier passant par trois agents.', wow: true, interactive: true },
